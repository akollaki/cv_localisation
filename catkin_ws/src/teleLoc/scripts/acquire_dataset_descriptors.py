...
#
# Functionality: computes descriptors for the given dataset. The list of
#                descriptors and their locations are then saved in a txt file
#                through the pickle functionality
#
...
class Descriptors():
    ...
    def getDescriptor(self, dataset_path, img_path, Hessian_val, descriptors):
        ...
        print ("Descriptors length is: " + str(len(descriptors)))
