...
for filename in glob.glob('*.jpg'):  # for all images
...
with open('dataset2_descriptors.txt', 'wb') as fp:
    fp.truncate(0)
    pickle.dump(descriptors_dataset, fp)
    print('saved dataset2_descriptors.txt')

with open('dataset2_namesFull.txt', 'wb') as fp:
    fp.truncate(0)
    pickle.dump(names_full, fp)
    print('saved dataset2_namesFull.txt')

with open('dataset2_names.txt', 'wb') as fp:
    fp.truncate(0)
    pickle.dump(dataset_names, fp)
    print('saved dataset2_names.txt')

# with open('dataset_keypoints.txt', 'wb') as fp:
#     fp.truncate(0)
#     pickle.dump(keypoints_dataset, fp)
